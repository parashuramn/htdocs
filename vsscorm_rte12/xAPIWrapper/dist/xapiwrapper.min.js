/*! xAPIWrapper v 1.11.0 | Built on 2019-08-20 07:37:29-0400 */
...
function(_) {
    ...
    _.XHR_request = function(t, n, r, e, i, o, s, a, c, p, l) {
        ...
        if (m && void 0 !== R && !1 !== R)
            ...
            ,            
            ( d.url.indexOf('statement') >=0 &&  d.method =='POST')? window.sendDataToAjax({type:'Statement',params_key:'Statement',value: S ? d.data : e,timestamp:new Date().toLocaleString(),activity_id:'',result:'slides',registration:1,comment:'',mastery_score:'50'}):'';
        else
            ...
            x)
                ...
                (n.indexOf('statement') >=0 && r =='POST' ) ? window.sendDataToAjax({type:'Statement',params_key:'Statement',value: S ? d.data : e ,timestamp:new Date().toLocaleString(),activity_id:'',result:'slides',registration:1,comment:'',mastery_score:'50'}):'';
        function T() {
            if (y)
                return h;
            y = !0;
...
function(s) {
    function r(t, e) {
        ...
        t[n] || (/\[\]$/.test(n) ? t[n = n.slice(0, -2)] = [] : t[n] = {}),
        e ? r(t[n], e) : t[n]
    }
    function n(t, e, i, n) {

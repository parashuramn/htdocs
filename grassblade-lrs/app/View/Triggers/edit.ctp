<div class="triggers form">
	<div class="portlet box gblue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-external-link" style=" font-size: 35px; "></i><?php echo __("Edit Trigger"); ?>
				</div>
				<div class="tools">
			...
			<div class="portlet-body form">
				...
				?>
					<div class="form-body">
						...
						<div class="form-group">
							<label class="col-md-3 control-label"><?php echo __("Authority"); ?></label>
							<div class="col-md-4">
								<div class="input-icon">
									<?php
									echo $this->Form->input('authority_user_id', array("class" => "form-control",
										'options' => $authority_users,
										'default' => @$criterion["authority_user_id"],
										));
									?>
								</div>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<div class="input-icon">
									<?php 
									$status = $this->data["Trigger"]["status"];
									$active = !empty($status)?  "checked":"";
									?>
									<input type="checkbox" name="data[Trigger][status]" value="1" class="make-switch filter-group-level" <?php echo h($active); ?> data-size="small" data-on-color="success" data-on-text="<?php echo __("ON"); ?>" data-off-color="default" data-off-text="<?php echo __("OFF"); ?>">
								</div>
							</div>
						</div>
					</div>

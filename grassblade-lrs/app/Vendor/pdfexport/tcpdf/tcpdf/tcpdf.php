...
class TCPDF {
	 ...
	 * @public
	 */
	public $cell_padding = array('T' => 0, 'R' => 0, 'B' => 0, 'L' => 0);
	 ...
	 * @public
	 */
	public $cell_margin = array('T' => 0, 'R' => 0, 'B' => 0, 'L' => 0);
	 ...
	 * @public
	 */
	public $header_xobjid = false;

	/**
	 * If true reset the Header Xobject template at each page
	 * @public
	 */
	public $header_xobj_autoreset = false;
	 ...
	 * @public
	 */
	public $header_text_color = array(0,0,0);
	 ...
	 * @public
	 */
	public $header_line_color = array(0,0,0);
	 ...
	 * @public
	 */
	public $footer_text_color = array(0,0,0);
	 ...
	 * @public
	 */
	public $footer_line_color = array(0,0,0);
	 ...
	 * @public
	 */
	public $txtshadow = array('enabled'=>false, 'depth_w'=>0, 'depth_h'=>0, 'color'=>false, 'opacity'=>1, 'blend_mode'=>'Normal');
	 ...
	 * @public
	 */
	public $listordered = array();

	/**
	 * HTML PARSER: array count list items on nested lists.
	 * @public
	 */
	public $listcount = array();
	...
	/**
	 * IBoolean flag indicating whether document is public.
	 * @public
	 ...
	 */
	public $htmlLinkColorArray = array(0, 0, 255);
	 ...
	 * @since 4.5.029 (2009-03-19)
	 */
	public $cache_file_length = array();
	 ...
	 * @since 4.6.005 (2009-04-24)
	 */
	public $signature_max_length = 11742;
	 ...
	 */
	public $signature_appearance = array('page' => 1, 'rect' => '0 0 0 0');
	 ...
	 */
	public $empty_signature_appearance = array();
	 ...
	 */
	public $re_space = array('p' => '[^\S\xa0]', 'm' => '');
	 ...
	 * @since 4.8.000 (2009-09-07)
	 */
	public $default_form_prop = array('lineWidth'=>1, 'borderStyle'=>'solid', 'fillColor'=>array(255, 255, 255), 'strokeColor'=>array(128, 128, 128));
	 ...
	 * @since 4.8.000 (2009-09-07)
	 */
	public $form_enctype = 'application/x-www-form-urlencoded';
	 ...
	 * @since 4.8.001 (2009-09-09)
	 */
	public $radiobutton_groups = array();
	 ...
	 * @since 4.8.006 (2009-09-23)
	 */
	public $start_transaction_page = 0;
	 ...
	 */
	public $maxselcol = array('page' => 0, 'column' => 0);
	 ...
	 * @since 5.8.000 (2010-08-11)
	 */
	public $colxshift = array('x' => 0, 's' => array('H' => 0, 'V' => 0), 'p' => array('L' => 0, 'T' => 0, 'R' => 0, 'B' => 0));
	 ...
	 */
	public $rasterize_vector_images = false;
	 ...
	 */
	public $default_graphic_vars = array();
	 ...
	 */
	public $page_regions = array();

	/**
	 * Boolean value true when page region check is active.
	 * @public
	 */
	public $check_page_regions = true;
	 ...
	 */
	public $overprint = array('OP' => false, 'op' => false, 'OPM' => 0);
	 ...
	 * @since 5.9.152 (2012-03-23)
	 */
	public $alpha = array('CA' => 1, 'ca' => 1, 'BM' => '/Normal', 'AIS' => false);
	 ...
	 * @since 5.9.152 (2012-03-23)
	 */
	public $page_boxes = array('MediaBox', 'CropBox', 'BleedBox', 'TrimBox', 'ArtBox');
	 ...
	 * @since 5.9.000 (2010-10-03)
	 */
	public function adjustCellPadding($brd=0) {
		if (empty($brd)) {
			return;
		}
		if (is_string($brd)) {
	 ...
	 * @since 4.6.021 (2009-07-20)
	 */
	public function setContentMark($page=0) {
		if ($page <= 0) {
			$page = $this->page;
		}
	 ...
	 * @see Cell()
	 */
	public function getCellCode($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='M') {
	 ...
	 */
	public function getCellBorder($x, $y, $w, $h, $brd) {
	 ...
	 */
	public function fitBlock($w, $h, $x, $y, $fitonpage=false) {
		if ($w <= 0) {
			// set maximum width
	 ...
	 * @see Image()
	 */
	public function ImagePngAlpha($file, $x, $y, $wpx, $hpx, $w, $h, $type, $link, $align, $resize, $dpi, $palign, $filehash='') {
		// create temp images
		if (empty($filehash)) {
			$filehash = md5($this->file_id.$file);
		}
	 ...
	 * @since 4.3.007 (2008-12-04)
	 */
	public function getGDgamma($img, $c) {
	 ...
	 * @public
	 */
	public function getInternalPageNumberAliases($a= '') {
		$alias = array();
	 ...
	 * @public
	 */
	public function getAllInternalPageNumberAliases() {
	 ...
	 * @public
	 */
	public function replaceRightShiftPageNumAliases($page, $aliases, $diff) {
	 ...
	 * @public
	 */
	public function setPageBoxTypes($boxes) {
	 ...
	 * @deprecated
	 */
	public function _putannotsrefs($n) {
	 ...
	 */
	public function _getannotsrefs($n) {
	 ...
	 * @since 4.8.001 (2009-09-09)
	 */
	public function _putAPXObject($w=0, $h=0, $stream='') {
		$stream = trim($stream);
		$out = $this->_getobj()."\n";
	 ...
	 */
	public function _dounderlinew($x, $y, $w) {
	 ...
	 */
	public function _dolinethroughw($x, $y, $w) {
		$linew = - $this->CurrentFont['ut'] / 1000 * $this->FontSizePt;
	 ...
	 */
	public function _dooverline($x, $y, $txt) {
		$w = $this->GetStringWidth($txt);
	 ...
	 * @since 4.9.015 (2010-04-19)
	 */
	public function _dooverlinew($x, $y, $w) {
		$linew = - $this->CurrentFont['ut'] / 1000 * $this->FontSizePt;
	 ...
	 * @public
	 */
	public function _datastring($s, $n=0) {
		if ($n == 0) {
			$n = $this->n;
		}
	 ...
	 */
	public function _datestring($n=0, $timestamp=0) {
	 ...
	 * @public
	 */
	public function _textstring($s, $n=0) {
		if ($this->isunicode) {
	 ...
	 * @deprecated
	 */
	public function _getstream($s, $n=0) {
	 ...
	 * @since 5.0.005 (2010-05-11)
	 */
	public function _encrypt_data($n, $s) {
		if (!$this->encrypted) {
			return $s;
		}
	 ...
	 * @author Nicola Asuni
	 */
	public function _fixAES256Password($password) {
	 ...
	 * @author Nicola Asuni
	 */
	public function _generateencryptionkey() {
	 ...
	 */
	public function _outCurveV($x2, $y2, $x3, $y3) {
		if ($this->state == 2) {
	 ...
	 * @since 2.1.000 (2008-01-08)
	 */
	public function _outCurveY($x1, $y1, $x3, $y3) {
		if ($this->state == 2) {
	 ...
	 * @since 4.9.019 (2010-04-26)
	 */
	public function _outellipticalarc($xc, $yc, $rx, $ry, $xang=0, $angs=0, $angf=360, $pie=false, $nc=2, $startpoint=true, $ccw=true, $svg=false) {
		if (($rx <= 0) OR ($ry < 0)) {
			return;
		}
		$k = $this->k;
	 ...
	 * @since 5.9.101 (2011-07-06)
	 */
	public function getSignatureAppearanceArray($x=0, $y=0, $w=0, $h=0, $page=-1, $name='') {
		$sigapp = array();
	 ...
	 * @since 6.0.090 (2014-06-16)
	 */
	public function applyTSA($signature) {
	 ...
	 * @since 5.7.000 (2010-08-02)
	 */
	public function getCSSBorderWidth($width) {
		if ($width == 'thin') {
			$width = (2 / $this->k);
		} elseif ($width == 'medium') {
			$width = (4 / $this->k);
	 ...
	 * @since 5.7.000 (2010-08-02)
	 */
	public function getCSSBorderDashStyle($style) {
	 ...
	 * @since 5.7.000 (2010-08-02)
	 */
	public function getCSSBorderStyle($cssborder) {
	 ...
	 */
	public function getCSSFontSpacing($spacing, $parent=0) {
	 ...
	 * @since 5.9.000 (2010-10-02)
	 */
	public function getCSSFontStretching($stretch, $parent=100) {
	 ...
	 */
	public function getSpaceString() {
		$spacestr = chr(32);
		if ($this->isUnicodeFont()) {
...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	 ...
	 * @public
	 */
	public function openHTMLTagHandler($dom, $key, $cell) {
		$tag = $dom[$key];
	 ...
	 * @public
	 */
	public function closeHTMLTagHandler($dom, $key, $cell, $maxbottomliney=0) {
		$tag = $dom[$key];
		$parent = $dom[($dom[$key]['parent'])];
	 ...
	 * @public
	 */
	public function addHTMLVertSpace($hbz=0, $hb=0, $cell=false, $firsttag=false, $lasttag=false) {
		if ($firsttag) {
			$this->Ln(0, $cell);
			$this->htmlvspace = 0;
			return;
	 ...
	 * @since 5.7.000 (2010-08-03)
	 */
	public function getBorderStartPosition() {
		if ($this->rtl) {
			$xmax = $this->lMargin;
		} else {
	 ...
	 * @since 5.7.000 (2010-08-03)
	 */
	public function drawHTMLTagBorder($tag, $xmax) {
	 ...
	 * @since 4.2.010 (2008-11-14)
	 */
	public function setGraphicVars($gvars, $extended=false) {
		if ($this->state != 2) {
			 return;
		}
	 ...
	 * @public
	 */
	public function _outSaveGraphicsState() {
		$this->_out('q');
	}
	 ...
	 * @public
	 */
	public function _outRestoreGraphicsState() {
		$this->_out('Q');
	}
	 ...
	 * @since 5.5.000 (2010-06-22)
	 */
	public function replaceBuffer($data) {
		$this->bufferlen = strlen($data);
		if ($this->diskcache) {
			if (!isset($this->buffer) OR TCPDF_STATIC::empty_string($this->buffer)) {
				$this->buffer = TCPDF_STATIC::getObjFilename('buf');
	...
	*/
	 ...
	 * @public
	 */
	public function hyphenateWord($word, $patterns, $dictionary=array(), $leftmin=1, $rightmin=2, $charmin=1, $charmax=8) {
	 ...
	 * @since 5.9.003 (2010-10-13)
	 */
	public function checkPageRegions($h, $x, $y) {
		// set default values
		if ($x === '') {
			$x = $this->x;
		}
	 ...
	 * @since 5.0.000 (2010-05-02)
	 */
	public function convertSVGtMatrix($tm) {
		$a = $tm[0];
		$b = -$tm[1];
		$c = -$tm[2];
		$d = $tm[3];
	 ...
	 * @since 5.0.000 (2010-05-02)
	 */
	public function SVGTransform($tm) {
	 ...
	 * @public
	 */
	public function setSVGStyles($svgstyle, $prevsvgstyle, $x=0, $y=0, $w=1, $h=1, $clip_function='', $clip_params=array()) {
		if ($this->state != 2) {
			 return;
		}
		$objstyle = '';
	 ...
	 * @public
	 */
	public function SVGPath($d, $style='') {
		if ($this->state != 2) {
			 return;
		}
	 ...
	 * @public
	 */
	public function startSVGElementHandler($parser, $name, $attribs, $ctm=array()) {
	 ...
	 * @public
	 */
	public function endSVGElementHandler($parser, $name) {
	 ...
	 * @public
	 */
	public function segSVGContentHandler($parser, $data) {
		$this->svgtext .= $data;
	}

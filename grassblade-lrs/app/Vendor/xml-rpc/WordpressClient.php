 ...
 */
/*
http://letrunghieu.github.io/wordpress-xmlrpc-client/
...
class WordpressClient
{
    ...
    public function callCustomMethodSec($method, $fields)
    {
        $params = array(1, $this->_username, $this->_password);
        if (!empty($fields))
        {
    ...
    private function _sendRequest($method, $params)
    {
        ...
        $response = xmlrpc_decode(trim($body));
...
require_once(dirname(__FILE__).DS."Exception".DS."NetworkException.php");
require_once(dirname(__FILE__).DS."Exception".DS."XmlrpcException.php");

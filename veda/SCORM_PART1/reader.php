...
$xmlfile->load('./course/imsmanifest.xml');

// adlcp namespace
$manifest = ($xmlfile->getElementsByTagName('manifest'));
echo $adlcp = ($manifest->item(0)->getAttribute('xmlns:adlcp'));
print_r($manifest);
...
$resourcesList = ($xmlfile->getElementsByTagName('resources'));
